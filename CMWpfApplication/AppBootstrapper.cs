...
namespace CMWpfApplication
{
    public class AppBootstrapper : BootstrapperBase
    {
        ...
        {
            DisplayRootViewFor<ITestDGViewModel>();
        }
        ...
        protected override void Configure()
        {
            ...
            this.windsorContainer.Register(Component.For<ITestDGViewModel>().ImplementedBy<TestDGViewModel>().LifeStyle.Is(LifestyleType.Singleton));
        }
        ...
        protected override void BuildUp(object instance)
        {
            instance.GetType().GetProperties()
                ...
                .ToList().ForEach(property => property.SetValue(instance, this.windsorContainer.Resolve(property.PropertyType), null));
        }
    }
}
